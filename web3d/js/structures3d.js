...
function initMaterials3D() {
  ...
  MAT3D = {
    ...
    concrete: t(TEX3D.concrete, 1, 1, { emissive: 0x2a2e33, emissiveIntensity: 0.35 }),
    ...
    white: new THREE.MeshStandardMaterial({ color: 0xf2f4f6, roughness: 0.75,
      emissive: 0x39424c, emissiveIntensity: 0.55 }),
    steel: new THREE.MeshStandardMaterial({ color: 0xb8bec6, roughness: 0.42, metalness: 0.7 }),
    darkSteel: new THREE.MeshStandardMaterial({ color: 0x6a717a, roughness: 0.55, metalness: 0.5,
      emissive: 0x1a1e23, emissiveIntensity: 0.5 }),
