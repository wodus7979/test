...
namespace OriginalFirearmAssets
{
    public static class FirearmPackBuilder
    {
        ...
        [MenuItem("Tools/Firearm Asset Pack/Build Prefabs")]
        public static void Build()
        {
            ...
            // Each run writes a new folder, preserving previously edited prefabs/materials.
            string target = AssetDatabase.GenerateUniqueAssetPath(Root + "/Generated");
            ...
            try
            {
                ...
                Selection.activeObject = AssetDatabase.LoadAssetAtPath<UnityEngine.Object>(target + "/Prefabs");
                EditorGUIUtility.PingObject(Selection.activeObject);
                Debug.Log("Created " + completed + " firearm prefabs in " + target + "/Prefabs. Units: meters; muzzle direction: local +Z.");
            }
        ...
        static Material[] MakeMaterials(string target)
        {
            ...
            for (int i = 0; i < Names.Length; i++)
            {
                ...
                AssetDatabase.CreateAsset(mat, target + "/Materials/" + Names[i] + ".mat");
                result[i] = mat;
            }
            return result;
        }
        ...
        static void BuildModel(SourceModel source, Material[] materials, string target)
        {
            ...
            try
            {
                foreach (var entry in groups)
                {
                    ...
                    AssetDatabase.CreateAsset(mesh, target + "/Meshes/" + mesh.name + ".asset");
