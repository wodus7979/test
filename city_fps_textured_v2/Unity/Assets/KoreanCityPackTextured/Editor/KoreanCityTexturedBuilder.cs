...
namespace OriginalKoreanCityTextured
{
    public static class KoreanCityTexturedBuilder
    {
        const string Root = "Assets/KoreanCityPackTextured";
        ...
        [MenuItem("Tools/Korean City Textured/Build Assets and Sample Scene")]
        public static void Build()
        {
            if (!Directory.Exists(Root + "/Source")) throw new DirectoryNotFoundException("Copy KoreanCityPackTextured into Assets before building.");
