...
SOURCE=ROOT/'Unity/Assets/KoreanCityPack/Source'
...
for path in list((ROOT/'Models').glob('*.glb'))+[ROOT/'korean_city_layout.glb']:
 ...
 assert g['images'][0]['mimeType']=='image/png'
report['glb_validation']='23 GLB files: headers, chunk lengths, buffer ranges, accessor sizes and embedded atlas verified.'
