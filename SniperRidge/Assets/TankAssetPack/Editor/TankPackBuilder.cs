...
namespace OriginalTankAssets
{
    ...
    public static class TankPackBuilder
    {
        ...
        public const string Target = "Assets/Resources/Tank";
        static bool building;
        static TankPackBuilder()
        {
    ...
    public sealed class TankBuildCheck : IPreprocessBuildWithReport
    {
        public int callbackOrder => 0;
        public void OnPreprocessBuild(BuildReport report) => TankPackBuilder.BuildIfMissing();
    }
}
